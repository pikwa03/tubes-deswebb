      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 gap-1 mb-5">
              ...
              <div className="relative mb-4">
                ...
                <span className="absolute left-3 top-9">
                  <img src="/images/train.png" alt="class Icon" className="w-6 h-6" />
                </span>
          ...
          <div className="absolute bottom-4 right-4">
            <button
              className="bg-[#55AD9B] text-white font-bold py-2 px-6 rounded-full hover:bg-green-700 transition"
              onClick={() => console.log('Cari Kereta clicked')}
            >
              Cari Kereta
            </button>
          </div>
